...
export const LocationVisualizationView: React.FC = () => {
        ...
        <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-sm font-bold">
            ...
            <div className="shrink-0">
              <span className={`px-4 py-2.5 rounded-xl text-sm font-extrabold border shadow-sm ${activeLoc.badge}`}>
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 text-sm text-slate-600 dark:text-slate-300">
                    <div>
                  ...
                  {animal.currentObservation && (
                    <div className="mt-3 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-sm text-slate-700 dark:text-slate-300">
                      <span className="font-bold text-amber-700 dark:text-amber-400 block text-xs uppercase mb-0.5">
                        Observação Atual:
                      </span>
                      "{animal.currentObservation}"
                    </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm transition-colors shadow-sm"
                >
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-sm font-bold tracking-wider text-slate-500 dark:text-slate-400 uppercase mb-4 px-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {locationKeys.map((locKey) => {
            ...
            return (
              ...
              >
                <div className="space-y-1">
                  <h3 className="font-black text-lg sm:text-xl text-slate-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                    {loc.label}
                  </h3>
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-3 py-1.5 rounded-full text-sm font-extrabold border ${loc.badge}`}>
                    {count}
                  </span>
